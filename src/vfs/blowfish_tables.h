// Blowfish initialisation tables: the hexadecimal digits of pi.
//
// Derived from OpenTS code/blowfish.cpp, which derives from Electronic Arts'
// GPL-released Command & Conquer source. The Blowfish algorithm itself is in
// the public domain.
//
...
inline constexpr std::uint32_t kBfPInit[18] = {
...
inline constexpr std::uint32_t kBfSInit[4][256] = {
    {
